  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background text-foreground shadow-lg ring-1 ring-foreground/10 duration-300 outline-none data-open:animate-in data-closed:animate-out",
          sideClasses[side],
          className
        )}
        {...props}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-3 border-t p-5", className)}
      {...props}
    />
  )
}
