...
export const metadata: Metadata = {
  ...
  description:
    "These Terms of Service govern your use of the King Bio Labs website and the purchase of research-grade compounds listed on it.",
};
  ...
  return (
    <LegalArticle title="Terms of Service">
      <p className="leading-relaxed text-muted-foreground">
        These Terms of Service govern your use of the King Bio Labs website and
      ...
      <LegalSection heading="Limitation of Liability">
        <p>
          To the maximum extent permitted by law, King Bio Labs is not liable
